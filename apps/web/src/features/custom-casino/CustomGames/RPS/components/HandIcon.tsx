...
import rockIconAlt from '@/features/custom-casino/assets/svg/rps-rock-icon-alt-centered.png'
import paperIconAlt from '@/features/custom-casino/assets/svg/rps-paper-icon-alt.svg'
import scissorsIconAlt from '@/features/custom-casino/assets/svg/rps-scissors-icon-alt.svg'

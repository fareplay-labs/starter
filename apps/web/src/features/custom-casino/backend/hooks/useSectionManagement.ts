...
export const useSectionManagement = () => {
  ...
  const updateSectionGames = useCallback(async (
    ...
    try {
      await BackendService.updateSectionGames(userId, sectionId, gameIds)
  ...
  const createSection = useCallback(async (
    ...
    try {
      const sectionId = await BackendService.createSection(userId, title, layout)
  ...
  const deleteSection = useCallback(async (
    ...
    try {
      await BackendService.deleteSection(userId, sectionId)

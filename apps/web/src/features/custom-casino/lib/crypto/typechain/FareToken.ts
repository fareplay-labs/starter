...
type ApprovalEvent = TypedEvent<[string, string, BigNumber], ApprovalEventObject>
...
type TransferEvent = TypedEvent<[string, string, BigNumber], TransferEventObject>
...
export interface FareToken extends BaseContract {
  ...
  burn(value: BigNumberish, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  estimateGas: {
    ...
    burn(value: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>

// @ts-nocheck
// Import sound files
import spinStartSound from '@/components/CustomUserCasinos/assets/audio/Device 7 Start.wav'
import reelStopSound from '@/components/CustomUserCasinos/assets/audio/Click 11.wav'
import clickSound from '@/components/CustomUserCasinos/assets/audio/Click 12.wav'

// Win sounds - coins with increasing intensity
import coinSound1 from '@/components/CustomUserCasinos/assets/audio/coins/Coins 01.wav'
import coinSound2 from '@/components/CustomUserCasinos/assets/audio/coins/Coins 05.wav'
import coinSound3 from '@/components/CustomUserCasinos/assets/audio/coins/Coins 10.wav'
import coinSound4 from '@/components/CustomUserCasinos/assets/audio/coins/Coins 15.wav'
import coinSound5 from '@/components/CustomUserCasinos/assets/audio/coins/Coins 20.wav'

// Special effect sounds
import megaWinSound from '@/components/CustomUserCasinos/assets/audio/Explosion49.wav'
import sparkSound from '@/components/CustomUserCasinos/assets/audio/Spark 20.wav'
import errorSound from '@/components/CustomUserCasinos/assets/audio/Error 07.wav'

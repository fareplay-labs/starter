...
var ICONS = {
  add: async () => (await import("./add-IEYHGK6Z.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-L3PEYJZH.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-RIIIOJIO.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-LAMQ5IU4.js")).appStoreSvg,
  apple: async () => (await import("./apple-QU37TJMR.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-MROPONAZ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-3SRVCPGL.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-AHM5HA3C.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-O5S5EPLZ.js")).arrowTopSvg,
  bank: async () => (await import("./bank-JRHKPT44.js")).bankSvg,
  browser: async () => (await import("./browser-2M6KJFAZ.js")).browserSvg,
  card: async () => (await import("./card-K5BB5QFO.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-YUME3UPZ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-WNJNDFYG.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-N5OHJ3Z5.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-KZ7FMFNB.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-YBUQ2YQR.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-6K7GJU4O.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-MO64AJ35.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-4CWMR4UK.js")).clockSvg,
  close: async () => (await import("./close-UB6HB4EY.js")).closeSvg,
  compass: async () => (await import("./compass-DM4UVDVY.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-VCLC4RNC.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-REZHHCYE.js")).copySvg,
  cursor: async () => (await import("./cursor-K7LSDGWC.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-JOIBTWW4.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-X65IWML7.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-CAVK2IRM.js")).disconnectSvg,
  discord: async () => (await import("./discord-3D2D5RHD.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-EJPX2YJG.js")).etherscanSvg,
  extension: async () => (await import("./extension-BED27CTE.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-IOBXXZSU.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-BYEWMEI2.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-X4POERNQ.js")).farcasterSvg,
  filters: async () => (await import("./filters-N43OGEW2.js")).filtersSvg,
  github: async () => (await import("./github-MLDHGZSP.js")).githubSvg,
  google: async () => (await import("./google-Z56ROO4L.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-M6AU763X.js")).helpCircleSvg,
  image: async () => (await import("./image-XKAMGTZJ.js")).imageSvg,
  id: async () => (await import("./id-45OYUPPX.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-ZDUUWF4X.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-S3VMSEKV.js")).lightbulbSvg,
  mail: async () => (await import("./mail-DVELYXJK.js")).mailSvg,
  mobile: async () => (await import("./mobile-RRSTCP2L.js")).mobileSvg,
  more: async () => (await import("./more-KPUXUHEJ.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-WYKJQU4H.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-ICWBDSCE.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-YXGM46WK.js")).offSvg,
  playStore: async () => (await import("./play-store-O2JCI4EN.js")).playStoreSvg,
  plus: async () => (await import("./plus-WEYBOZNN.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-WNJPZSUQ.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-W33N2JP7.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-MPNXJBX6.js")).refreshSvg,
  search: async () => (await import("./search-O5J56N7K.js")).searchSvg,
  send: async () => (await import("./send-CIZOSMOC.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-W7FIC2CT.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-QSX2EP4X.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-VP6EGNAW.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-YBTDWFQB.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-UL46U2V4.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-PQZZERRX.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-3PRTWIGY.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-VNKRUSL2.js")).twitchSvg,
  twitter: async () => (await import("./x-X4BORUK7.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-2JDA2YDQ.js")).twitterIconSvg,
  verify: async () => (await import("./verify-666ZSWLK.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-EWSD65NL.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-ED7DE5VQ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-URWP2QT4.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-URWP2QT4.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-URWP2QT4.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-CRP3DCSI.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-4GVMP2Q3.js")).warningCircleSvg,
  x: async () => (await import("./x-X4BORUK7.js")).xSvg,
  info: async () => (await import("./info-ETDEM7XH.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-5NGCWU2E.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-K6JVVQID.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YJGIZUBY.js.map

...
const solana_parser_service_1 = require("./solana-parser.service");
let SolanaModule = class SolanaModule {
};
exports.SolanaModule = SolanaModule;
exports.SolanaModule = SolanaModule = __decorate([
    (0, common_1.Module)({
        providers: [solana_parser_service_1.SolanaParserService],
        exports: [solana_parser_service_1.SolanaParserService],
    })
], SolanaModule);
